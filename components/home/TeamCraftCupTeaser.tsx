    ...
    <div className="w-full max-w-md mx-auto">
      <div className="relative overflow-hidden rounded-2xl border border-amber-800/40 bg-gradient-to-br from-amber-900/30 via-zinc-900 to-orange-900/20 p-6">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="glow-breathe absolute -top-8 -right-8 w-40 h-40 rounded-full bg-amber-500/10 blur-3xl" />
          <div className="glow-breathe absolute -bottom-8 -left-8 w-32 h-32 rounded-full bg-orange-500/10 blur-3xl" style={{ animationDelay: "2s" }} />
        </div>

        <div className="relative z-10 text-center space-y-3">
          <p className="float-y font-display text-4xl">🏆</p>
          <div>
