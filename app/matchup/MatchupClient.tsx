...
function shareToX(
  text: string,
  result: { home: string; away: string; hs: number | string; as: number | string; kind: "single" | "series" }
) {
        ...
        <button
          onClick={() =>
            shareToX(
              ...
              { home: home.name, away: away.name, hs: wins.home, as: wins.away, kind: "series" }
            )
          }
